resource "google_sql_database_instance" "postgres_high" {
  name             = "praca-magisterska-db-high"
...
resource "google_sql_user" "postgres_user_high" {
  name        = var.GOOGLE_POSTGRESQL_NAME
  instance    = google_sql_database_instance.postgres_high.name
